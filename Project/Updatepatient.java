...
public class Updatepatient extends javax.swing.JFrame {
 ...
 Date date1=new Date();
    String radiotext="",b,s="",a,st,str,radiotext2="",radiotext3="";
    private void group(){
        group.add(radio1);
        group.add(radio2);
        group2.add(radio3);
