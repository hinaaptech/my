    ...
    private void docActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_docActionPerformed
      ...
      /*  try {
        ...
        if(doc.getSelectedItem().equals("Timing")){
            jLabel9.setText("Enter Patient Timing");
            txt20.setText("");
        }
        if(doc.getSelectedItem().equals("Country")){
            jLabel9.setText("Enter Patient Country");
            txt20.setText("");
        }
         if(doc.getSelectedItem().equals("City")){
            jLabel9.setText("Enter Patient City");
            txt20.setText("");
        }
      /*  } catch (Exception e) {
        }*/
