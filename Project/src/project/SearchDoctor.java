...
public class SearchDoctor extends javax.swing.JFrame {
 ...
 Date date1=new Date();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Search Doctor By :");

        doc.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select ", "Id", "First Name", "Gender", "Speciality" }));
    ...
    private void docActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_docActionPerformed
      ...
      /*  try {
        ...
        if(doc.getSelectedItem().equals("First Name")){
            jLabel9.setText("Enter Doctor First Name :");
            txt20.setText("");
        }
        if(doc.getSelectedItem().equals("Gender")){
            jLabel9.setText("Enter Doctor Gender :");
            txt20.setText("");
        }
           ...
           String s=txt20.getText();
             ...
             String s2=txt20.getText();
                String s3=txt20.getText();
                 ...
                 String str="select * from doctor where id='"+s+"' OR fname like '"+s1+"%' or gender like '"+s2+"%' or speciality like '"+s3+"%'"; /**/
