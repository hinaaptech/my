...
public class signup1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 460, 81, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 460, 81, 30));
...
try {
            ...
            JOptionPane.showMessageDialog(rootPane,"Please Insert Password");
                    ...
                    else if(txt3.getText().length()<=5 )
            {
            JOptionPane.showMessageDialog(rootPane,"To Week Password!!!");
            }
