...
public class SearchDoctor extends javax.swing.JFrame {
 ...
 Date date1=new Date();
    ...
    private void initComponents() {
        ...
        doc.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select ", "Id", "Name", "Timing", "Speciality" }));
        ...
        try {
            ...
            String s1=txt20.getText();
             ...
             String s3=txt20.getText();
                String s4=txt20.getText();
          String str="select * from doctor where id='"+s1+"' or fname like '"+s2+"%' or timing like '%"+s3+"%' or speciality like '"+txt20.getText()+"%'";
